...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    base_path('storage/app/public/billets'),
                    base_path('storage/app/public/passeports'),
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'nillscorporation@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'backup@bamboo-assur.com'),
                'name' => env('MAIL_FROM_NAME', 'Sauvegarde'),
            ],
        ],
